...
**color** | [**Color?**](Color.md) | Color of the annotation.<br />*Inherited from [PopupAnnotation](PopupAnnotation.md)* | [optional]
**open** | **Bool?** | Gets or sets a flag specifying whether the pop-up annotation should initially be displayed open.<br />*Inherited from [PopupAnnotation](PopupAnnotation.md)* | [optional]
...
[[Back to Model list]](../README.md#documentation-for-models) [[Back to API list]](../README.md#documentation-for-api-endpoints) [[Back to README]](../README.md) [[View Source]](../AsposePdfCloud/Models/PopupAnnotationWithParent.swift)
